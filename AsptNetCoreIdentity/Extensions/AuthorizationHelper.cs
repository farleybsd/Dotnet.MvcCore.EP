...
namespace AsptNetCoreIdentity.Extensions
{
    ...
    public class PermissaoNecessariaHandler : AuthorizationHandler<PermissaoNecessaria>
    {
        ...
        {
            if(context.User.HasClaim(c=> c.Type =="Permissao" && c.Value.Contains(requisito.Permissao))) //"Permissao" tem que ser gravado na tabelauserclaims
            {
